...
if (isset($_POST['addemployee'])) {
    ...
    $sql_category_id = "SELECT id FROM category WHERE name = 'product'";
...
if ($query->num_rows > 0) {
    ...
    $sql_insert = "INSERT INTO category (name) VALUES ('product')";
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="spares.php">Spare Parts</a></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#myaddmodal">
                                        <i class="fa fa-plus"></i> Add Spare
                                    </button>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            //working on category
                                            $sql_category = "SELECT id FROM category WHERE name = 'product'";
                                            ...
                                            while ($row = $result->fetch_assoc()) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class='btn btn-danger btn-sm' href='/garages/delete_spare.php?id=<?= $row['id'] ?>' onclick='return confirmDelete();'>Delete</a>
                                                    </td>
                                                </tr>
